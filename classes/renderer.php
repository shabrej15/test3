...
class theme_edpearson_renderer extends theme_roots_renderer {
    ...
    public function page_footer_nav($menudata) {
        $renderable = new theme_edpearson\output\page_footer_nav($menudata);
    ...
    protected function render_page_footer_nav($renderable) {
        ...
        return $this->render_from_template('theme_edpearson/page_footer_nav', $templatecontext);
    }
