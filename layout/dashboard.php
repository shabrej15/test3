...
$themerenderer = $PAGE->get_renderer('theme_edpearson');
...
<?php require("{$CFG->dirroot}/theme/edpearson/layout/partials/head.php"); ?>
...
<!-- Footer -->
<?php require("{$CFG->dirroot}/theme/edpearson/layout/partials/footer.php"); ?>
