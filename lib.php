...
use theme_edpearson\css_processor;
 ...
 * @return string
 */
function theme_edpearson_process_css($css, $theme) {
 ...
 * @return bool
 */
function theme_edpearson_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM && ($filearea === 'logo' || $filearea === 'favicon' || $filearea === 'backgroundimage')) {
        $theme = theme_config::load('edpearson');
